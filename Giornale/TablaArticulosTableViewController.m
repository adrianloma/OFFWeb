...
- (void)cellWasSwiped:(UIGestureRecognizer *)g {
    ...
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Article deleted"  message:@"Your article was deleted succesfully." delegate:self cancelButtonTitle:@"OK" otherButtonTitles:nil];
    [alertView show];
